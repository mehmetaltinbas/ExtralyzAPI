...
@Injectable()
export class ShortTypeStrategyProvider implements ExerciseSetTypeStrategy {
    constructor(
    ...
    async evaluateAnswer(exercise: ExerciseDocument, answer: string): Promise<EvaluateAnswerStrategyResponse> {
        ...
        return { isSuccess: true, message: 'evaluating answer is done', score: evaluationResponse.score, feedback: evaluationResponse.feedback };
    }
}